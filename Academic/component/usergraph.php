                    ...
                    <tbody>
                        <tr class="text-gray-700 dark:text-gray-100">
                            ...
                            <td
                                ...
                                <div class="flex items-center">
                                    <span class="mr-2">
                                        <?= number_format(($rowStudent['count'] / ($rowStudent['count'] + $rowTeacher['count'] + $rowAcademic['count'])) * 100, 2) ?>%
                                    </span>
                                    <div class="relative w-full">
                                        <div class="overflow-hidden h-2 text-xs flex rounded bg-blue-300">
                                            <div style="width: <?= number_format(($rowStudent['count'] / ($rowStudent['count'] + $rowTeacher['count'] + $rowAcademic['count'])) * 100, 2) ?>%"
                        ...
                        <tr class="text-gray-700 dark:text-gray-100">
                            ...
                            <td
                                ...
                                <div class="flex items-center">
                                    <span class="mr-2">
                                        <?= number_format(($rowTeacher['count'] / ($rowStudent['count'] + $rowTeacher['count'] + $rowAcademic['count'])) * 100, 2) ?>%
                                    </span>
                                    <div class="relative w-full">
                                        <div class="overflow-hidden h-2 text-xs flex rounded bg-red-300">
                                            <div style="width: <?= number_format(($rowTeacher['count'] / ($rowStudent['count'] + $rowTeacher['count'] + $rowAcademic['count'])) * 100, 2) ?>%"
                        ...
                        <tr class="text-gray-700 dark:text-gray-100">
                            ...
                            <td
                                ...
                                <div class="flex items-center">
                                    <span class="mr-2">
                                        <?= number_format(($rowAcademic['count'] / ($rowStudent['count'] + $rowTeacher['count'] + $rowAcademic['count'])) * 100, 2) ?>%
                                    </span>
                                    <div class="relative w-full">
                                        <div class="overflow-hidden h-2 text-xs flex rounded bg-green-300">
                                            <div style="width: <?= number_format(($rowAcademic['count'] / ($rowStudent['count'] + $rowTeacher['count'] + $rowAcademic['count'])) * 100, 2) ?>%"
