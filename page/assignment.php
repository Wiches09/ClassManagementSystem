...
<body class="bg-[#AFDAFF] flex flex-col w-full min-h-screen">
  ...
  if ($_SESSION['role'] == 'student') {
    echo '<div class="ml-60"><div class="flex pl-40 mb-4 border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900 w-full justify-center">
    ...
    echo '<div class="ml-60 mt-10"><div class="px-20 rounded-lg" id="assigned" role="tabpanel" aria-labelledby="assigned-tab">
      <!-- sort -->
      ...
      <div class="grid grid-cols-3 gap-20 py-20">
        ...
        <a href="work-page.php" class="hover:ring-4 ring-[#17A7CE] hover:opacity-85 rounded-md">
          <div class="bg-[#136C94] rounded-md">
            <!-- icon -->
            <div class="flex justify-center pt-10 pb-4">
              <svg class="w-20 h-20 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
