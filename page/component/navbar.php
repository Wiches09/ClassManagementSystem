...
?>
<div class="py-2 px-6 bg-[#f8f4f3] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-[130]">
        ...
        <li class="dropdown ml-3">
            <button type="button" class="dropdown-toggle flex items-center">
                ...
                <div class="p-2 md:block text-left">
                    <h2 class="text-sm font-semibold text-gray-800"><?= $_SESSION["firstname"] ?> <?= $_SESSION["lastname"] ?></h2>
                    <p class="text-xs text-gray-500"><?= $_SESSION["role"] ?></p>
                </div>
            </button>
