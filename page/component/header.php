...
<div class="fixed grid grid-cols-3 dark:bg-gray-900 shadow-xl w-full h-20">
  ...
  <div class="flex w-fit">
    <button data-collapse-toggle="navbar-hamburger" type="button" class="inline-flex items-center justify-center mx-5 my-5 w-fit h-fit text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
  ...
  <div class="flex">
    ...
    <div class="flex items-center justify-center px-10">
      <svg class="w-10 h-10 text-gray-800 dark:text-white justify-center" aria-hidden="true" fill="none" viewBox="0 0 28 28">
    ...
    <div class="flex mr-10 float-right items-center">
      <button type="button" class="flex justify-center items-center text-sm bg-gray-800 rounded-full ml-3 md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
    ...
    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
      ...
      <ul class="pt-2" aria-labelledby="user-menu-button">
        <form method="post" class="flex co content-center justify-center">
          <input type="submit" class="text-sm bg-cyan-950 text-white truncate px-2 py-1 rounded mb-0" name="logout" value="logout">
        </form>
        <?php
...
<div class="fixed left-0 top-0 w-60 h-full dark:bg-gray-900 p-4 z-50 sidebar-menu transition-transform text-white">
  ...
  <ul class="mt-4">
    <li class="mb-1 group">
      <a href="./index.php" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
    ...
    <li class="mb-1 group">
      <a href="./assignment.php" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" fill="none" viewBox="0 0 24 24">
    ...
    <li class="mb-1 group">
      <a href="./class-page.php" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
    ...
    <li class="mb-1 group">
      <a href="./classes.php" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
    ...
    <!-- Setting (do it later) -->
    <li class="mb-1 group">
      <a href="#" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
